  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data && data.editProfile) {
        ...
        alert("Profile updated but no data returned");
      }
    ...
    <div className="w-full flex justify-center">
      ...
      <div className="w-full max-w-3xl relative px-4 md:px-0 md:pr-16">
        <div className="flex justify-center relative">
          ...
          <div className="absolute [left:calc(33.3333%+70px)] -bottom-16 xs:-bottom-18 sm:-bottom-20 flex flex-col items-center">
